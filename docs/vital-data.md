# البيانات الحيوية — تطبيق نظم إدارة رياض الأطفال
...
| الحقل | القيمة |
|---|---|
| اسم التطبيق | نظم إدارة رياض الأطفال — الخاصة |
...
| الحقل | القيمة |
|---|---|
| اسم الروضة | نظم إدارة رياض الأطفال — الخاصة |
...
*تم إعداد هذا المستند بواسطة نظام الإدارة التقني — نظم إدارة رياض الأطفال*
