...
const dc = StyleSheet.create({
  card: {
    width: '100%', borderRadius: 24, overflow: 'hidden', marginBottom: 32,
    borderWidth: 1.5, borderColor: 'rgba(20,184,166,0.35)',
    shadowColor: '#14B8A6', shadowOffset: { width: 0, height: 6 },
    shadowOpacity: 0.20, shadowRadius: 18, elevation: 10,
  },
  topGrad: { paddingTop: 20, paddingHorizontal: 20, paddingBottom: 18 },

  badgeRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 },
  pill: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: 'rgba(20,184,166,0.18)', paddingHorizontal: 10, paddingVertical: 4,
    borderRadius: 20, borderWidth: 1, borderColor: 'rgba(20,184,166,0.40)',
  },
  pillTxt: { fontSize: 10, fontFamily: 'Inter_700Bold', color: '#2DD4BF', letterSpacing: 0.5 },
  tagBadge: {
    backgroundColor: 'rgba(255,255,255,0.06)', paddingHorizontal: 9, paddingVertical: 3,
    borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.10)',
  },
  tagTxt: { fontSize: 9, fontFamily: 'Inter_500Medium', color: 'rgba(255,255,255,0.40)' },
  ...
  avatar: {
    ...
    justifyContent: 'center', alignItems: 'center',
    borderWidth: 2, borderColor: 'rgba(20,184,166,0.55)',
    shadowColor: '#14B8A6', shadowOffset: { width: 0, height: 0 },
    shadowOpacity: 0.45, shadowRadius: 10, elevation: 6,
  },
  heroText: { flex: 1, alignItems: 'flex-end' },
  devName: { fontSize: 18, fontFamily: 'Inter_700Bold', color: '#FFFFFF', textAlign: 'right', marginBottom: 2 },
  devRole: { fontSize: 11, fontFamily: 'Inter_400Regular', color: 'rgba(255,255,255,0.50)', textAlign: 'right', marginBottom: 8 },
  tagRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 5, justifyContent: 'flex-end' },
  tag: {
    paddingHorizontal: 7, paddingVertical: 2, borderRadius: 7,
    backgroundColor: 'rgba(20,184,166,0.12)', borderWidth: 1, borderColor: 'rgba(20,184,166,0.28)',
  },
  tagLabel: { fontSize: 9, fontFamily: 'Inter_600SemiBold', color: '#2DD4BF' },
  ...
  statNum: { fontSize: 16, fontFamily: 'Inter_700Bold', color: '#2DD4BF' },
  statLbl: { fontSize: 9, fontFamily: 'Inter_400Regular', color: 'rgba(255,255,255,0.40)', textAlign: 'center' },
  ...
  actWa:   { backgroundColor: 'rgba(37,211,102,0.10)', borderColor: 'rgba(37,211,102,0.35)' },
  actPort: { backgroundColor: 'rgba(20,184,166,0.10)', borderColor: 'rgba(20,184,166,0.35)' },
  actTxt:  { fontSize: 12, fontFamily: 'Inter_700Bold' },

  footerGrad: { paddingVertical: 10, paddingHorizontal: 18, alignItems: 'center', gap: 3 },
  footerLine: { fontSize: 9, fontFamily: 'Inter_400Regular', color: 'rgba(255,255,255,0.22)', textAlign: 'center' },
});
...
function DesignerCard() {
  ...
  return (
    <View style={dc.card}>
      <LinearGradient
        colors={['#021018', '#032030', '#043d50', '#032030', '#021018']}
        start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}
        style={dc.topGrad}
      >
        {/* Hex decos */}
        <View style={StyleSheet.absoluteFill} pointerEvents="none">
          <View style={{ position: 'absolute', right: -20, top: -20, opacity: 0.14 }}>
            <HexFrame size={90} fill="transparent" stroke="#14B8A6" strokeWidth={1.5} />
          </View>
          <View style={{ position: 'absolute', left: -10, bottom: -16, opacity: 0.08 }}>
            <HexFrame size={66} fill="transparent" stroke="#ffffff" strokeWidth={1} />
          </View>
        </View>
        ...
        <View style={dc.statsRow}>
          {[
            ...
            <View key={st.lbl} style={dc.statBox}>
              <Text style={dc.statNum}>{st.num}</Text>
              <Text style={dc.statLbl}>{st.lbl}</Text>
            </View>
          ))}
        </View>
